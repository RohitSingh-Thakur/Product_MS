...
public class GlobalHttpRequest_Product {
	...
	public static final String GET_COMPLETE_PRODUCT_BY_ID = "/getCompleteProductById/{productId}";
	...
	public static final String GET_COMPLETE_PRODUCT_BY_NAME = "/getCompleteProductByName";
